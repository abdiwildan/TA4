...
<div class="col-lg-8">
    <form method="post" action="/dashboard/products/{{ $product -> slug }}">
        ...
        <div class="mb-2">
          ...
          <input type="text" class="form-control @error('name_product') is-invalid @enderror" id="name_product" name="name_product" required autofocus value="{{ old('name_product', $product->name_product) }}">
            @error('name_product')
